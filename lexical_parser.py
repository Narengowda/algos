...
# operators [AND, OR] and the following arithmetic operators:
# EQUALS (EQ), GREATER THAN (GT), LESS THAN (LT), CONTAINS (IN)
# An expression always follows the format: [OPERATOR, OPERAND, COMPARISON_VALUE(S)]
...
# and the expression should evaluate to TRUE or FALSE
# The OPERAND & COMPARISION_VALUE(S) could refer to a value in the input
# object or be an absolute value.
